...
- Terminal provider: richer key/mouse handling and full-screen terminal interaction polish on top of the current node-pty/ConPTY session path and renderer PTY viewport.
