...
- `npm run release:readiness` audits release artifacts, browser store package/submission packet/readiness metadata, the latest release soak evidence report, and remaining manual blockers.
