...
- A transcription MVP boundary exists with transcript/audio schemas, mock ASR, optional sidecar ASR interface, session/user lexicon correction, action-slot confidence scoring, and clarification policy. Real local ASR backend selection remains behind this interface.
