...
- Real Browser Action semantic dogfood evidence is recorded in `docs/reports/browser-action-dogfood-evidence-2026-05-08.md` and `docs/reports/browser-action-e2e-dogfood-evidence-2026-05-08.md`; the native desktop path now includes a bounded Rust Windows UI Automation helper for browser-window observe/execute fallback, with the prior PowerShell helper preserved as a development fallback. Authenticode release signing remains blocked on a code-signing certificate or CI signing service.
