# Computer-Use Process Validation 30 - 2026-05-14
...
- Eval runs: `40`
- Perception graphs: `10`
- Failure-memory records: `15`
- Eval resources: `7`
- DAG runs: `1`
- Task success rate in completed eval runs: `0.692`
- Proof rate: `0.308`
- p95 latency ms: `141`
- p95 perception latency ms: `40`

Supporting JSON: `docs/reports/assets/computer-use-process-validation-30-2026-05-14/evidence.json`
...
4) 개선 및 후속 필요작업: Add a bounded browser print-to-PDF/download capability with file proof, redaction, and rollback-safe storage.
...
4) 개선 및 후속 필요작업: Add browser download completion watcher and eval-resource proof.

로그/재현성 판단: partially_supported_but_not_reliable_enough_for_repeated_live_use
...
4) 개선 및 후속 필요작업: Add confidence-gated VLM fallback capability with p95 budget and screenshot retention policy.
